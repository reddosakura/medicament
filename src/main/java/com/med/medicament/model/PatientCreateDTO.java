...
public class PatientCreateDTO {
    ...
    public UserIdDTO user_account;
    public AttachmentIdDTO attachment;
    public ArrayList<AppointmentDTO> appoints;

    public PatientCreateDTO() {
    }

    public PatientCreateDTO(String id, String lastname, String name, String patronymic, String phone_number, String emaildoc, Date bith_date, String citizenship, String gender, int height, int weight, int snils, PassportDTO passport, UserIdDTO user_account, AttachmentIdDTO attachment, ArrayList<AppointmentDTO> appoints) {
        this.id = id;
    ...
    public UserIdDTO getUser_account() {
        return user_account;
    }

    public void setUser_account(UserIdDTO user_account) {
        this.user_account = user_account;
    }

    public AttachmentIdDTO getAttachment() {
        return attachment;
    }

    public void setAttachment(AttachmentIdDTO attachment) {
        this.attachment = attachment;
    }
